...
public class FindQuestionsGUI extends JFrame {
   ...
   static class DecimalFormatRenderer extends DefaultTableCellRenderer {
	...
	private final JTable tableFees = new JTable();
	...
	private void jbInit() throws Exception
	{
		...
		scrollPaneQueries.setBounds(new Rectangle(40, 281, 320, 116));
		...
		tableQueries.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				Question que=(Question)tableModelQueries.getValueAt(i,2); // obtain question object
				Vector<Fee> fees=que.getFees();

				tableModelFees.setDataVector(null, columnNamesFees);
				tableModelFees.setColumnCount(3);
				if (fees.isEmpty())
					lblFees.setText(ResourceBundle.getBundle("Etiquetas").getString("NoFees")+": "+que.getQuestion());
				else 
					lblFees.setText(ResourceBundle.getBundle("Etiquetas").getString("SelectedQuestion")+" "+que.getQuestion());
		...
		scrollPaneFees.setBounds(372, 281, 266, 116);
		getContentPane().add(scrollPaneFees);
//		tableFees.setModel(new DefaultTableModel(
//			new Object[][] {
//			},
//			new String[] {
//				"Fee#", "Prediction", "Factor"
//			}
//		));
