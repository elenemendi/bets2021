...
public class FindQuestionsGUIReal extends JFrame {
	...
	private void jbInit() throws Exception
	{
		...
		this.setSize(new Dimension(877, 716));
		...
		jButtonClose.setBounds(new Rectangle(295, 541, 130, 30));
